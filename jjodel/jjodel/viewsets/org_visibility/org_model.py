...
from jjodel.jjodel.models.model import ModelOrgVisibility, Model
from jjodel.jjodel.permissions.visibility.orguser_visibility import \
    ShareVisibilityPermission
from jjodel.jjodel.serializers.org_visibility.org_model import \
...
class ModelOrgVisibilityViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return ModelOrgVisibility.objects.filter(model__namespace=model,
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            ModelOrgVisibility.objects.update_or_create(organization=organization,
                                                        model=model)
            ModelOrgVisibility.objects.filter(organization=organization,
