...
from jjodel.jjodel.models import Viewpoint, ViewOrgVisibility, Organization
...
class ViewpointOrgVisibilityViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return ViewpointOrgVisibility.objects.filter(viewpoint__name=vpname,
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            ViewpointOrgVisibility.objects.update_or_create(organization=organization,
                                                            viewpoint=vp)
            ViewpointOrgVisibility.objects.filter(organization=organization,
                                                  viewpoint=vp).update(
                readonly=readonly)
