...
from jjodel.jjodel.models import Viewpoint, User, View, ViewUserVisibility
...
class ViewUserVisibilityViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        return ViewUserVisibility.objects.filter(view__name=view,
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            ViewUserVisibility.objects.update_or_create(user=user,
                                                        view=view)
