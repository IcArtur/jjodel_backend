...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('isPublic', models.BooleanField(default=False, verbose_name='Pubblico')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('isPublic', models.BooleanField(default=False, verbose_name='Pubblico')),
                ('openMembership', models.BooleanField(default=False, verbose_name='Pubblico')),
                ('name', models.TextField(verbose_name='Nome')),
                ('mailDomainRequired', models.TextField(verbose_name='Mail Domain')),
                ('bio', models.TextField(verbose_name='Bio')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.groupmember')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('surname', models.TextField(blank=True, null=True, verbose_name='Cognome')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('preview_image', models.BinaryField(blank=True, null=True, verbose_name='Preview Immagine')),
                ('description', models.TextField(verbose_name='Descrizione')),
                ('is_public', models.BooleanField(default=False, verbose_name='Pubblico')),
                ('html', models.TextField(blank=True, null=True, verbose_name='Testo HTML')),
            ],
        ),
        migrations.CreateModel(
            name='Viewpoint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.user')),
                ('view', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.view')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, null=True, verbose_name='Commento')),
                ('view', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.view')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='model',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.user'),
        ),
        migrations.AddField(
            model_name='model',
            name='instanceOf',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='jjodel.model'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.user')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.organization')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.organization'),
        ),
        migrations.CreateModel(
            name='AdminMember',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('since', models.DateField(blank=True, editable=False, null=True)),
                ('admin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.user')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jjodel.organization')),
            ],
        ),
    ]
